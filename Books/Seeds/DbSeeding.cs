					...
					Book = new Book()
					{
						...
						Reviews = new List<Review>()
						{
							new Review {
								...
								Comment = "Reviewing Call of the Wild and it is awesome beyond words",
								Rating = 5,
							...
							new Review
							{
								...
								Comment = "Reviewing Call of the Wild and it is terrrible book",
								Rating = 1,
								Reviewer = new Reviewer()
								{
									FirstName = "Peter",
							...
							new Review
							{
								Headline = "Decent Book",
								Comment = "Not a bad read, I kind of liked it",
								Rating = 3,
								Reviewer = new Reviewer()
								{
									FirstName = "Paul",
				...
				new BookAuthor()
				{
					Book = new Book()
					{
						...
						BookCategories = new List<BookCategory>()
						{
							new BookCategory
							{
								Category = new Category() { Name = "Western"}
							}
						},
						Reviews = new List<Review>()
						{
							new Review { Headline = "Awesome Western Book",
								Comment = "Reviewing Winnetou and it is awesome book",
								Rating = 4,
								Reviewer = new Reviewer()
								{
									FirstName = "Frank",
					...
					Book = new Book()
					{
						...
						Reviews = new List<Review>()
						{
							...
							{ Headline = "Awesome Programming Book",
								Comment = "Reviewing Pavols Best Book and it is awesome beyond words",
								Rating = 5,
								Reviewer = new Reviewer()
								{
									FirstName = "Pavol2",
					...
					Book = new Book()
					{
						...
						Reviews = new List<Review>()
						{
							new Review
							{
								...
								Comment = "This book made me cry a few times",
								Rating = 5,
								Reviewer = new Reviewer()
								{
									FirstName = "Allison",
							...
							new Review
							{
								...
								Comment = "My wife made me read it and I hated it",
								Rating = 1,
								Reviewer = new Reviewer()
								{
									FirstName = "Kyle",
